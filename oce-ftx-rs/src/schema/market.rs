...
pub struct Market {
    ...
    #[serde(deserialize_with = "crate::schema::deserialize_null_default")]
    pub r#min_provide_size: Decimal,
    ...
    #[serde(deserialize_with = "crate::schema::deserialize_null_default")]
    pub r#price_increment: Decimal,
    
    // no description
    // example value: 0.0001
    #[serde(rename = "sizeIncrement")]
    #[serde(deserialize_with = "crate::schema::deserialize_null_default")]
    pub r#size_increment: Decimal,
